      ...
      <div className="max-container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            >
              <motion.img 
                src="/micronutrient-lp/public/lovable-uploads/57bb13a1-d547-4f58-9cc6-590e9225eb13.png" 
              ...
              />
              <motion.img 
                src="/micronutrient-lp/public/lovable-uploads/ebffafc2-e9af-46d5-9ac1-837426db5e84.png" 
